...
class Peer:
    ...
    def get_stats(self):
        """Calculates the number of blocks each peer has in the longest chain and the total blocks
        generated by each peer in the longest chain
    ...
    def show_fraction_of_chain(self):
        """Displays a bar graph showing the fraction of blocks in the main chain that have been created 
        by this peer and the fraction created by all other peers
    ...
    def show_fraction_of_total_blocks(self):
        """Displays a bar graph showing the fraction of blocks created by this peer that went into the main chain,
        fraction of blocks created by all other peers that went into the main chain and fraction of blocks created
        by all peers that went into the main chain
    ...
    def show_final_stats(self):
        ...
        and the average size of the pending transactions pool when mining a block and the success ratio across all
        peers
